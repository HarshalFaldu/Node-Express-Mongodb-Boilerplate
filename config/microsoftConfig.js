...
exports.creds = {
    // Required
    // Just change tenant_guid with your tenant_id
    identityMetadata: 'https://login.microsoftonline.com/<tenant_guid>/.well-known/openid-configuration',
    // identityMetadata: 'https://login.microsoftonline.com/f64e4b48-ce7f-4c5f-b876-d9ccce468856/.well-known/openid-configuration',
    ...
    // redirectUrl: config.HOST.url+'/auth/openid/return',
    // Here change your requirection link with your link in Active Directory
    redirectUrl: 'https://<HOST>/auth/openid/return',
    ...
    // Update your client secret here
    clientSecret: '6K~7Q~ZWzo~MbncDya9w56A~yH0qSsErHnSp1',
    //secret id edee8d06-f3fa-4e26-b566-88634ecd4446
  ...
  // Change your logout redirection link here
  exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri='+'https://<HOST>';
  ...
  exports.databaseUri = 'mongodb://localhost:27017/OIDCStrategy';
